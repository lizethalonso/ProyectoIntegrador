        ...
        fetch(url,settings)
            ...
            .then(data => {
                ...
                for(paciente of data){
                    ...
                    //cada fila tendrá un id que luego nos permitirá borrar la fila si eliminamos el pacientes
                    ...
                    //a la función de java script findBy que se encargará de buscar el pacientes que queremos
